 ...
 */
export declare function fromConfig(options: AllureStoreConfig): Promise<AllureStore>;
/**
 * Create an AllureStore from a directory of raw allure-results.
 */
export declare function fromDirectory(resultsDirectory: string, options?: AllureStoreDirectoryConfig): Promise<AllureStore>;
/**
 ...
 */
export declare function fromReport(input: string, options?: AllureStoreReportConfig): Promise<AllureStore>;
...
export { type CompiledReportSource, FileReportSource, UrlReportSource, HtmlReportSource, } from './CompiledReportSource';
export * from './types';
